$SVRVDIprocesses = @(
  @{
    ...
    Script = "https://github.com/osdcloudcline/Update-Scripts/raw/main/Individual%20Scripts/GUI-based/Virtual%20Desktop%20Interfaces/Server%20Operating%20Systems/Browsers.ps1"
    },
  @{
   Name = "Processing: Media Software"
   Script = "https://github.com/osdcloudcline/Update-Scripts/raw/main/Individual%20Scripts/GUI-based/Virtual%20Desktop%20Interfaces/Server%20Operating%20Systems/Media.ps1"
   },
  @{
  Name = "Processing: Productivity Software"
  Script = "https://github.com/osdcloudcline/Update-Scripts/raw/main/Individual%20Scripts/GUI-based/Virtual%20Desktop%20Interfaces/Server%20Operating%20Systems/Productivity.ps1"
  },
  @{
  Name = "Processing: Programming Software"
  Script = "https://github.com/osdcloudcline/Update-Scripts/raw/main/Individual%20Scripts/GUI-based/Virtual%20Desktop%20Interfaces/Server%20Operating%20Systems/Programming.ps1"
  },
  @{
  ...
  Start-SplashScreen -Processes $SVRVDIprocesses -MessageHeader "Server VDI System Configuration - Updating: $env:computername"
